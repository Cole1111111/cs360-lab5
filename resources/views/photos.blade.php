...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <img src="{{ asset('images/mini.jpg') }}" class="img-fluid gallery-img" alt="miniature">
    ...
    <div class="modal fade" id="myModal2" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                <img src="{{ asset('images/water tower.jpg') }}" class="img-fluid gallery-img" alt=" waber tow">
    ...
    <img src="{{ asset('campus.jpg') }}" class="img-fluid gallery-img" alt="Uidaho Campus">
    ...
    <div class="modal fade" id="myModal3" tabindex="-1" aria-labelledby="exampleModalLabel3" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img src="{{ asset('images/campus.jpg') }}" class="img-fluid gallery-img" alt="Uidaho Campus">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                </div>
